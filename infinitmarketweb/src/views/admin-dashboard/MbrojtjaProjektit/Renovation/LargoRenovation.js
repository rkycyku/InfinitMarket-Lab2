...
function LargoRenovation(props) {
  ...
  async function handleSubmit() {
    try {
      await axios.delete(`https://localhost:7251/api/MbrojtjaEProjektit/Renovation/FshijRenovation?RenovationID=${props.id}`, authentikimi);
      props.setTipiMesazhit('success');
      props.setPershkrimiMesazhit('Renovation u fshi me sukses!');
      ...
      props.setPershkrimiMesazhit('Ndodhi nje gabim gjate fshirjes se renovation!');
      props.perditesoTeDhenat();
      props.shfaqmesazhin();
    }
  }
...
export default LargoRenovation;
