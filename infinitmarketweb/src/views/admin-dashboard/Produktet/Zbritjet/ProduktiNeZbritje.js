...
function ProduktiNeZbritje(props) {
    ...
    const vendosProduktet = async () => {
      try {
        const produktet = await axios.get(
          `https://localhost:7251/api/Produktet/Produkti/ShfaqProduktet`, authentikimi
        );
  ...
  function handleSubmit() {
    if (zbritjaNeRregull === true && kaZbritje === false) {
      axios.post('https://localhost:7251/api/Produktet/ZbritjaQmimitProduktit/shtoZbritjenProduktit', {
        produktiId: produkti,
