...
function ShtoKompanit(props) {
  ...
  async function handleSubmit() {
    axios
        .post(
          'https://localhost:7251/api/Produktet/Kompania/shtoKompanin',
          {
            emriKompanis: emri,
            adresa: adresa
          },
        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
              ...
              <Form.Control onChange={(e) => handleAdresaChange(e.target.value)} value={adresa} type="text" placeholder="Adresa Kompanis" />
            </Form.Group>
          </Form>
        </Modal.Body>
        <Modal.Footer>
