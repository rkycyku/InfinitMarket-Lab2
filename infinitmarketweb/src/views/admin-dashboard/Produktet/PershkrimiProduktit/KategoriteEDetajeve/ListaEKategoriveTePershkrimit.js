...
function ListaEKategoriveTePershkrimit(props) {
  ...
  return (
    <div>
      ...
      {shto && <ShtoKategorineEDetajeve handleClose={() => handleClose} perditesoTeDhenat={() => setPerditeso(Date.now())} />}
      {shfaqMesazhin && <Mesazhi setShfaqMesazhin={setShfaqMesazhin} pershkrimi={pershkrimiMesazhit} tipi={tipiMesazhit} />}
      {edito && <EditoKategorinEdetajeve handleClose={handleClose} id={id} />}
      {fshij && (
