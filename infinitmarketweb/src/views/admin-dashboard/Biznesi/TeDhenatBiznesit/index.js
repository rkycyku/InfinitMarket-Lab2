...
function TeDhenatEBiznesit(props) {
    ...
    async function handleRuaj(e) {
        ...
        if (foto) {
            ...
            try {
                await axios.post(`https://localhost:7251/api/TeNdryshme/VendosFotot/PerditesoTeDhenatBiznesit?logoVjeter=${teDhenatBiznesit.logo}`, formData, authentikimi)
                    .then(async (response) => {
                        axios.put("https://localhost:7251/api/Biznesi/TeDhenatBiznesit/PerditesoTeDhenat", {
            ...
            await axios.put("https://localhost:7251/api/Biznesi/TeDhenatBiznesit/PerditesoTeDhenat", {
                "emriIbiznesit": formValue.emriIBiznesit,
                "shkurtesaEmritBiznesit": formValue.shkurtesaEmrit,
                "nui": formValue.nui,
                "nf": formValue.nf,
