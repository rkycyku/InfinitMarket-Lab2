  ...
  async function handleRuaj(e) {
    ...
    if (foto) {
      ...
      try {
        await axios
          .post(
            `https://localhost:7251/api/TeNdryshme/VendosFotot/PerditesoTeDhenatBiznesit?logoVjeter=${teDhenatBiznesit.logo}`,
            formData,
            authentikimi
          )
          .then(async (response) => {
            axios.put(
              'https://localhost:7251/api/Biznesi/TeDhenatBiznesit/PerditesoTeDhenat',
              {
          ...
          <div className="TeDhenatContainer mb-4">
            ...
            <MDBRow tag="form" className="g-3">
              ...
              <MDBCol md="4" style={{ margin: '1em' }}>
                {teDhenatBiznesit &&
                (teDhenatBiznesit.logo === null || teDhenatBiznesit.logo === '' || teDhenatBiznesit.logo === 'PaLogo.png') ? (
                  <div className="logo">
              ...
              <div className="col-12">
                {!edito && (
                  <button className="btn btn-primary btn-small" role="button" onClick={handleEdito}>
                    Ndrysho te dhenat
                  </button>
                )}

                {edito && (
                  <button className="btn btn-primary btn-small" role="button" onClick={handleRuaj}>
                    Ruaj
                  </button>
                )}
              </div>
