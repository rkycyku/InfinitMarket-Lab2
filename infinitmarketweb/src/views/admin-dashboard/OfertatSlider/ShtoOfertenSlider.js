...
function ShtoOfertenSlider(props) {
  ...
  async function handleSubmit() {
    ...
    try {
      await axios.post('https://localhost:7251/api/VendosFotot/ShtoOfertenSlider', formData, authentikimi).then(async (response) => {
        axios
          .post(
            'https://localhost:7251/TeNdryshme/VendosOfertatSlider',
            {
